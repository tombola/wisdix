 ...
 */
function wisdix_css_alter(&$css) {
  if (isset($css['misc/ui/jquery.ui.theme.css'])) {
    $css['misc/ui/jquery.ui.theme.css']['data'] =
      drupal_get_path('theme', 'wisdix') . '/jquery-ui-1.10.0.custom.css';
  }
}
 ...
 */
function wisdix_module_implements_alter(&$implementations, $hook) {
 ...
 */
function wisdix_preprocess_page(&$vars) {
 ...
 */
function wisdix_menu_tree(&$variables) {
 ...
 */
function wisdix_menu_link(&$variables) {
  // override Radix menu.inc with default Drupal behavior
